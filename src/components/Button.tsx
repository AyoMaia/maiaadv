...
const variantStyles = {
  solid: {
    ...
    white:
      'bg-yellow-600 text-white hover:bg-yellow-500 active:bg-blue-200 active:text-slate-600 focus-visible:outline-white',
  },
  outline: {
    slate:
    ...
    white:
      'ring-yellow-700 text-white hover:ring-yellow-500 active:ring-slate-700 active:text-slate-400 focus-visible:outline-white',
  },
}
